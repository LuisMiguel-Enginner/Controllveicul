...
try {
    ...
    error_log('Erro ao carregar veículos do barracão Pesados: ' . $e->getMessage());
    $veiculos = [];
    $total_veiculos = 0;
    $placas = [];
}
    ...
    <main class="main-content">
        ...
        <header class="dashboard-header">
            <div class="header-left">
                <h1>Barracão - Pesados</h1>
                <p class="header-subtitle">Veículos atualmente na oficina Barracão Pesados</p>
            </div>
        </header>
        ...
        <section class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <p class="stat-label">Veículos no Barracão Pesados</p>
        ...
        <section class="table-section">
            <div class="table-header">
                <h3>Veículos da Barracão Pesados</h3>
            </div>
            <div style="display:flex; gap:10px; align-items:center; padding: 0 24px 12px;">
                <form method="GET" style="display:flex; gap:10px; align-items:center; width:100%;">
                    ...
                    <?php if ($data_inicial || $data_final || $placa_filtro): ?>
                        <a href="barracao_pesados.php" class="btn-secondary" style="margin-left:auto;">Limpar</a>
                    <?php endif; ?>
                </form>
            </div>
            <script>
                        ...
                        <?php if (empty($veiculos)): ?>
                            <tr>
                                <td colspan="7" style="text-align: center; padding: 30px; color: var(--text-gray);">
                                    ...
                                    Nenhum veículo cadastrado para a Barracão Pesados.
                                </td>
                            </tr>
                        <?php else: ?>
